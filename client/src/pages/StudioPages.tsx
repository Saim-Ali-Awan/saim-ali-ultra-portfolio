...
export function PortfolioPage() {
  const { data } = trpc.portfolio.getAll.useQuery(undefined, { staleTime: 60_000 });
  const projects = data?.projects?.length ? data.projects : [{ id: 1, title: "Kinetic / Commerce", projectType: "Product system", summary: "A conversion-minded interface where motion makes a complex product feel obvious.", imageUrl: "/manus-storage/saima-project-kinetic_c3802524.jpg", projectUrl: "#", tags: ["Next.js"] }];
